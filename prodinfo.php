<?php
	...
	echo "<p><center><img src='images/".$thearrayprod['prodPicName'].".jpg'></center>";
	echo "<p><center>".$thearrayprod['prodDescrip']."</center>";
	echo "<p><center>&#163; ".$thearrayprod['prodPrice']." /unit</center>";
	echo "<p><center>In Stock: ".$thearrayprod['prodQuantity']." units</center>";
